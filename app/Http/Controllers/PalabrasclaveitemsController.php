...
class PalabrasclaveitemsController extends Controller
{
    ...
    public function obtenerPalabrasClaveItem(Request $request)
    {
        ...
        try {
            ...
            $palabrasClave = Palabrasclaveitem::obtenerPalabrasClaveItem($itemId);           
    ...
    public function crearPalabraClaveItem(Request $request) {
        ...
        try {
            ...
            if( !empty( $itemId ) && !empty( $palabra ) ) {
                ...
                // Crea el usuario
                $id = Palabrasclaveitem::crearPalabraClaveItem( $data );
    ...
    public function eliminarPalabrasClaveItem(Request $request) {
        ...
        try {
            ...
            if( !empty( $palabraId ) ) {
                ...
                if( Palabrasclaveitem::eliminarPalabraClaveItem( $palabraId ) ) {
                    $resp['estado'] = true;
